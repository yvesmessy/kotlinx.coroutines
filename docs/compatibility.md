...
* API is completely removed. While we give our best efforts not to do so and have no plans of removing any API, we sill are leaving 
this option in case of unforeseen problems such as security problems.
