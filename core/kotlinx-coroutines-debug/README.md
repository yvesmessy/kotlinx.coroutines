...
```
dependencies {
    testImplementation 'org.jetbrains.kotlinx:kotlinx-coroutines-debug:1.1.0-native-1.3.20-eap-52'
}
```
...
You can run your application with an additional argument: `-javaagent:kotlinx-coroutines-debug-1.1.0-native-1.3.20-eap-52.jar`.
