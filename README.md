...
[![Download](https://api.bintray.com/packages/kotlin/kotlinx/kotlinx.coroutines/images/download.svg?version=1.1.0-native-1.3.20-eap-52) ](https://bintray.com/kotlin/kotlinx/kotlinx.coroutines/1.1.0-native-1.3.20-eap-52)

Library support for Kotlin coroutines with [multiplatform](#multiplatform) support.
This is a companion version for Kotlin `1.3.20-eap-52` release.
...
<dependency>
    ...
    <version>1.1.0-native-1.3.20-eap-52</version>
</dependency>
```
...
```xml
<properties>
    <kotlin.version>1.3.20-eap-52</kotlin.version>
</properties>
```
...
```groovy
dependencies {
    implementation 'org.jetbrains.kotlinx:kotlinx-coroutines-core:1.1.0-native-1.3.20-eap-52'
}
```
...
```groovy
implementation 'org.jetbrains.kotlinx:kotlinx-coroutines-android:1.1.0-native-1.3.20-eap-52'
```
