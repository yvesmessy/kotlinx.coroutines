...
open class SequencePlaysScrabble : ShakespearePlaysScrabble() {
    ...
    public override fun play(): List<Map.Entry<Int, List<String>>> {
        ...
        val buildHistoOnScore: (((String) -> Int) -> Sequence<TreeMap<Int, List<String>>>) = { score ->
            sequence {
                yield(shakespeareWords.asSequence()
    ...
    private fun String.asSequence(startIndex: Int = 0, endIndex: Int = length) = sequence {
